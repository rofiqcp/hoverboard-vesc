...
assert 'MCCONF_STEERING_POSITION_CURRENT_MAX_MA   15000u' in (R/'Src/motor/mcconf_default.h').read_text(), 'steering current ceiling regression must match the active 15.0 A runtime safety limit'
