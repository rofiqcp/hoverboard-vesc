...
volatile uint32_t encoder_align_power_on_count=0u, encoder_align_phase0_count=0u, encoder_align_final_count=0u;
volatile int32_t encoder_align_phase0_delta=0, encoder_align_total_delta=0;
volatile int16_t encoder_align_sector_delta[6]={0,0,0,0,0,0};
volatile uint32_t encoder_align_checkpoint_raw[6]={0,0,0,0,0,0};
volatile uint16_t encoder_align_expected_sector_counts=0u, encoder_align_current_ma=0u;
