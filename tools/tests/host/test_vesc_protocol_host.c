...
volatile int32_t encoder_align_jog_delta=0, encoder_align_back_delta=0, encoder_align_sweep360_delta=0;
volatile uint8_t encoder_align_consensus_run=0u, encoder_align_consensus_valid=0u;
